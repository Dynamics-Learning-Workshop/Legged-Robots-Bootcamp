...
def autofunc_c(double roll, double pitch, double yaw, double roll_lh, double pitch_lh, double yaw_lh, double pitch_lk, double w, double l1, double l2):
    ...
    cdef np.ndarray[np.double_t, ndim=2] out_5241214194046891435 = np.empty((3,14))
    autofunc(roll, pitch, yaw, roll_lh, pitch_lh, yaw_lh, pitch_lk, w, l1, l2, <double*> out_5241214194046891435.data)
    return out_5241214194046891435