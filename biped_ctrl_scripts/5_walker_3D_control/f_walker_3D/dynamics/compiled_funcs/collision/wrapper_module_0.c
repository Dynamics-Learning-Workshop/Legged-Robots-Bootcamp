...
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_r = __pyx_pf_16wrapper_module_0_autofunc_c(__pyx_self, __pyx_v_roll, __pyx_v_pitch, __pyx_v_yaw, __pyx_v_roll_lh, __pyx_v_pitch_lh, __pyx_v_yaw_lh, __pyx_v_pitch_lk, __pyx_v_roll_rh, __pyx_v_pitch_rh, __pyx_v_yaw_rh, __pyx_v_pitch_rk, __pyx_v_w, __pyx_v_l1, __pyx_v_l2);
